...
## Deployment Guide for ZOMATO Project
--------------------------------------------
...
eksctl create cluster --name=rpcluster --region=ap-northeast-1 --zones=ap-northeast-1a,ap-northeast-1c --without-nodegroup
...
(OR)
eksctl utils associate-iam-oidc-provider --region ap-northeast-1 --cluster rpcluster --approve
